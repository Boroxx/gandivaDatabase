...
Ein Filter benötigt zuerst ein \texttt{Schema}-Objekt, welches aus einer Liste von \texttt{Field}-Objekten erstellt wird. Ebenso benötigt es ein \texttt{Condition}-TreeNode.
